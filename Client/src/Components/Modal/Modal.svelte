<script lang="ts">
    ...
    export let styleBg: stringmap = { top: 0, left: 0 };
    export let styleWindow:stringmap = {};
    export let styleContent:stringmap = {};
    export let styleCloseButton:stringmap = {};
    ...
    const camelCaseToDash = (str:string) => str
      .replace(/([a-zA-Z])(?=[A-Z])/g, '$1-').toLowerCase();
  
    const toCssString = (props: stringmap) => Object.keys(props)
      .reduce((str, key) => `${str}; ${camelCaseToDash(key)}: ${props[key]}`, '');
  
    // eslint-disable-next-line no-prototype-builtins
    const isSvelteComponent = (component: Object) => SvelteComponent && SvelteComponent.isPrototypeOf && SvelteComponent.isPrototypeOf(component);
    ...
    const handleOuterClick = (event:KeyboardEvent) => {
      if (
  ...
  {#if Component}
    <div
      ...
      style={cssBg}
    >
      <div class=" container" bind:this={wrap}>
        <div
          class="card"
          role="dialog"
          aria-modal="true"
