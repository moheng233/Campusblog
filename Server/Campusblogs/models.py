...
class Posts(models.Model):
    ...
    blog = ForeignKey(
        Blogs, on_delete=models.CASCADE, verbose_name="博客", related_name="posts"
    )
...
class Reports(models.Model):
    ...
    user = ForeignKey(
        ...
        on_delete=models.CASCADE,
        verbose_name="举报人",
        related_name="informant",
    )
    informants = ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
        verbose_name="被举报人",
        related_name="informants",
    )
